<h3 class="d-flex justify-content-md-center mr-auto ml-auto mt-5">RPS Management System</h3>
        ...
        <div class="row">
            <div class="card mr-auto ml-auto">
                <div class="card-header">
                    <h5>Upload RPS form</h5>
                </div>
                <!-- <form class="" action="" method="POST"> -->
                <?php echo form_open_multipart('pdf/addrps');?>
                    <div class="card-body">
                        <!-- <div class=" "> -->
...
<div class="row d-flex justify-content-md-center" style="overflow-x: scroll; white-space: nowrap">
    <table class="table table-striped table-bordered" style="overflow-x: scroll; white-space: nowrap; display: block;"  id="list_smt">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?=$key->upload_by;?></td>
                <td>
                    <a href="<?= base_url();?>/pdf/downloadrps/<?= $key->file?>" class="btn btn-success">Download</a>
                    <?php 
                        if ($this->session->userdata('level')=='admin') {?>
                            <a href="<?=base_url();?>/pdf/deleterps/<?=$key->kode_matkul?>/<?=base64_encode($key->file)?>"class="btn btn-danger" onclick="return confirm('are you sure want to delete this data?')">Delete</a>
                    <?php }
                    ?>
                </td>
            </tr>
