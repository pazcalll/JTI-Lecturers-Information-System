<div class="container ml-auto">
  <div class="row">
    ...
    <div class="col-8 mt-4 mb-lg-5">
      ...
      <h2>List View</h2>
      <ul>
        <li><a href="<?=base_url();?>/project/dpa18">DPA 2018/2019</a></li>
        <li><a href="<?=base_url();?>/project/dpa19">DPA 2019/2020</a></li>
        <li><b>Lecturers:</b>
          <ul>
            <li><a href="<?=base_url();?>/project/cpns">CPNS Lecturers</a></li>
            <li><a href="<?=base_url();?>/project/lb">External Lecturers</a></li>
            <li><a href="<?=base_url();?>/project/mku">MKU Lecturers</a></li>
            <li><a href="<?=base_url();?>/project/pns">Government Employee Lecturers</a></li>
          </ul>
        </li>
        <li><a href="<?=base_url();?>/project/listSemester" name="List Matkul Semester">List Matkul Semester</a></li>
      </ul>
    </div>
    <div class="col-2"></div>
  </div>
